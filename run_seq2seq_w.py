...
from modeling_unilm import UnilmForSeq2Seq, UnilmConfig, UnilmForSeq2Seq_w
from modeling_albert_test import AlbertForSeq2Seq
...
MODEL_CLASSES = {
    ...
    'albert': (AutoConfig, UnilmForSeq2Seq_w, BertTokenizer),
    'albert_1': (AutoConfig, AlbertForSeq2Seq, BertTokenizer)
}

# config = AutoConfig.from_pretrained(model_type, cache_dir="../pretrained")
